...
function unl_fourone_og_form_system_theme_settings_alter(&$form, &$form_state) {
  global $user;

  $form['advanced_settings'] += array(
    'unl_fourone_og_base_path' => array(
      '#type' => 'textfield',
      '#title' => t('Base breadcrumb path'),
      '#default_value' => theme_get_setting('unl_fourone_og_base_path'),
